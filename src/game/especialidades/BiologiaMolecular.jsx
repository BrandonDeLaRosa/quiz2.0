...
import BiologiaMolecularModal from '../modals/BiologiaMolecularModal'
...
const BiologiaMolecular = () => {
  ...
  return (
    <div>
      {showModal ? (
        <BiologiaMolecularModal modal={showModal} setModal={setShowModal} selectedIndex={selectedIndex} />
      ) : (
