...
import InolabModal from '../modals/InolabModal'
...
const Inolab = () => {
  ...
  return (
    <div>
      {showModal ? (
        <InolabModal modal={showModal} setModal={setShowModal} selectedIndex={selectedIndex} />
      ) : (
        <section className="columns">
          <div className="column">
            <div className="columnName">Inolab</div>
